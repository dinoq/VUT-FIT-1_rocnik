...
def third_task():
    ...
    wordfreq_eskymo = {i:eskymo.count(i) for i in eskymo}  # vase reseni
    # test
...
def fourth_task():
    ...
    backward_except_last = udubutubudu[:len(udubutubudu)-1][::-1] # vase reseni
    # test
...
def fifth_task():
    ...
    skip2_str = ', '.join(map(str, skip2))   # vase reseni
    # test
