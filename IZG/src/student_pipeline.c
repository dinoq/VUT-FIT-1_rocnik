...
void gpu_runVertexPuller(GPUVertexPullerOutput *const              output,
  ...
  VertexIndex idx = gpu_computeGLVertexID(puller->indices, vertexShaderInvocation);
  for(int i=0;i < MAX_ATTRIBUTES; i++){
    if(&puller->heads[i].enabled)
      output->attributes[i]=gpu_computeVertexAttributeDataPointer(&puller->heads[i],idx);
    else
...
void gpu_computeScreenSpaceBarycentrics(
  ...
  coords->data[0] = ((vertices[1].data[1] - vertices[2].data[1]) * (pixelCenter[0].data[0] - vertices[2].data[0]) + (vertices[2].data[0] - vertices[1].data[0]) * (pixelCenter[0].data[1] - vertices[2].data[1])) / ((vertices[1].data[1] - vertices[2].data[1]) * (vertices[0].data[0] - vertices[2].data[0]) +
    (vertices[2].data[0] - vertices[1].data[0]) * (vertices[0].data[1] - vertices[2].data[1]));
  coords->data[1] = ((vertices[2].data[1] - vertices[0].data[1]) * (pixelCenter[0].data[0] - vertices[2].data[0]) + (vertices[0].data[0] - vertices[2].data[0]) * (pixelCenter[0].data[1] - vertices[2].data[1])) / ((vertices[1].data[1] - vertices[2].data[1]) * (vertices[0].data[0] - vertices[2].data[0]) +
    (vertices[2].data[0] - vertices[1].data[0]) * (vertices[0].data[1] - vertices[2].data[1]));
